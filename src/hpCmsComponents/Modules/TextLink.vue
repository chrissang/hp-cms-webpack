<template>
    <li :id="uniqueId" data-type="text-link-module">
        <div class="flexContainer">
            <div class="small-11 columns">
                <dl class="accordion" data-accordion="" role="tablist">
                    <dd class="accordion-navigation">
                        <a :href="'#accordion-'+uniqueId" :id="'accordion-heading-'+uniqueId" role="tab" class="handle">Text Link Module</a>
                        <div :id="'accordion-'+uniqueId" :aria-labelledby="'accordion-heading-'+uniqueId" role="tabpanel" class="content">
                            ...
                            <cta-inputs input-type="textarea"></cta-inputs>
                        </div>
                    </dd>
                </dl>
            </div>
